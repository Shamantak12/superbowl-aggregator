...
MONGO_URI = os.environ.get("MONGO_URI", "mongodb://localhost:27017/superbowl_articles")

client = MongoClient(MONGO_URI)
db = client["superbowl_articles"]
news_collection = db["articles"]

news_collection.create_index("url", unique=True)

NEWS_API_KEY = "d50d91379e2d40b69f289ce6e8ff29d7"
